...
impl From<Modifier> for ModifiersBitflag {
    // Converts the modifiers in their bitflags
    fn from(item: Modifier) -> Self {
        match item {
            Modifier::Shift => ModifiersBitflag::SHIFT,
            Modifier::Lock => ModifiersBitflag::LOCK,
            Modifier::Control => ModifiersBitflag::CONTROL,
            Modifier::Alt => ModifiersBitflag::MOD1,
            Modifier::Mod2 => ModifiersBitflag::MOD2,
            Modifier::Mod3 => ModifiersBitflag::MOD3,
            Modifier::Mod4 => ModifiersBitflag::MOD4,
            Modifier::Mod5 => ModifiersBitflag::MOD5,
        }
    }
}
...
impl VKService {
    ...
    /// If it was pressed before, release it
    /// If it was released before, press it
    pub fn toggle_modifier(&mut self, modifier: Modifier) -> Result<(), SubmitError> {
